        ...
        <div className="fixed left-0 w-screen bg-primaryBgColor flex justify-center z-20">
            <div className="w-[1000px] px-4  py-3 space-x-4  lg:py-3  flex items-center justify-between text-base md:text-[18px] bg-primaryBgColor">
                ...
                <div className="flex items-center space-x-5 text-white">
                    ...
                    <Link to="https://onve.notion.site/Team-shaka-75de92ed8c724c6ea9fd5661bb03d1c5">
                        {" "}
                        <div className="cursor-pointer">About Team</div>
                    </Link>
                    <Link
                        to="https://linktr.ee/briefingnews"
                        className=" btn hover:bg-white hover:text-primaryBgColor bg-primaryBgColor min-h-fit h-7 px-2 rounded-none  gap-0 text-white font-normal border border-white"
                    >
                        <span>Install</span>
                        <MdArrowOutward />
                    </Link>
