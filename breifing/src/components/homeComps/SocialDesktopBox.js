...
import image from "../../assets/images/social_image.svg";

export function SocialDesktopBox({ briefingList, date, timeOfDay }) {
          ...
          <div className="w-full flex flex-col">
            <div className="flex w-full">
              ...
              <div className=" w-1/2 flex justify-center items-center">
                <img src={image} alt="Social" className="w-full h-auto" />
              </div>
            </div>
            <div className="bg-[#B6B6B6] h-[1px] my-4"></div>
            <div className="flex">
