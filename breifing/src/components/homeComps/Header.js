...
const Header = () => {
    return (
        <div className='fixed left-0 w-screen bg-primaryBgColor flex justify-center'>
            <div className='sm:w-[1000px] py-3 space-x-4  lg:py-3 lg:px-20 flex items-center justify-between text-base md:text-[18px] bg-primaryBgColor'>
